...
const messages = {
  zh: {
    ...
    xieProfileText: "谢远定（1899—1928），伯平，湖北枣阳人。他从青年求学时期投身革命，在南京、襄阳、武汉等地参与党团建设与革命实践，是东南大学校史和南京早期党团史中的重要人物。",
    xieProfilePeriod1: "1899—1920 · 求学与启蒙",
    xieProfilePoint1: "早年在湖北求学，受到恽代英等进步人士影响，参加互助社、利群书社。1920 年考入南京高等师范学校，先入工科，后转入农科生物系。",
    xieProfilePeriod2: "1921—1923 · 投身青年运动",
    xieProfilePoint2: "1921 年 5 月加入中国社会主义青年团，以马克思主义研究会等形式传播进步思想；1922 年加入中国共产党。",
    xieProfilePeriod3: "1923—1925 · 南京党团实践",
    xieProfilePoint3: "1923 年作为南京团组织代表参加中国社会主义青年团第二次全国代表大会，同年担任南京城内第一个党小组组长，组织青年学生开展革命活动。",
    xieProfilePeriod4: "1925—1927 · 从襄阳到北伐",
    xieProfilePoint4: "回到湖北开展党团工作，在襄阳建立党团组织；后参加北伐，先后从事政治部秘书、宣传工作，并参与编辑《汉声周报》。",
    xieProfilePeriod5: "1927—1928 · 鄂北斗争与牺牲",
    xieProfilePoint5: "返回鄂北参与革命斗争。1928 年在汉口从事地下工作时被捕，同年 8 月英勇就义，年仅 29 岁。",
    xieSourcesTitle: "资料来源",
    xieSourceSeuhistory: "东南大学校史馆",
    xieSourceSeuaa: "东南大学校友总会",
    xieSourceNanjing: "南京党史网",
    ...
    chatAnswerLabel: "数字人回答",
    chatEvidenceTitle: "史料依据",
    chatEvidenceCount: "条数据库记录",
    chatEvidenceOpen: "展开核验",
    chatEvidenceClose: "收起依据",
    chatEvidenceNote: "以下内容来自数据库检索，用于补充回答并帮助核验信息可信度。",
    q1: "谢远定是谁？",
    q2: "谢远定和东南大学有什么关系？",
    q3: "谢远定为什么参加团二大？",
    q4: "团二大为什么在梅庵召开？",
  ...
  en: {
    ...
    xieProfileText: "Xie Yuanding (1899–1928), known as Boping, was born in Zaoyang, Hubei. From his student years onward, he took part in revolutionary work across Nanjing, Xiangyang, and Wuhan and became an important figure in Southeast University history and Nanjing's early Party and Youth League history.",
    xieProfilePeriod1: "1899–1920 · Education and awakening",
    xieProfilePoint1: "Influenced by progressive educators including Yun Daiying, he joined the Mutual Aid Society and Liqun Bookstore. In 1920 he entered Nanjing Higher Normal School, moving from engineering to agricultural biology.",
    xieProfilePeriod2: "1921–1923 · The youth movement",
    xieProfilePoint2: "He joined the Socialist Youth League of China in May 1921, promoted progressive thought through a Marxist study society, and joined the Communist Party of China in 1922.",
    xieProfilePeriod3: "1923–1925 · Organizing in Nanjing",
    xieProfilePoint3: "In 1923 he represented the Nanjing League organization at the Second National Congress and later led Nanjing's first Communist Party group, organizing revolutionary activities among students.",
    xieProfilePeriod4: "1925–1927 · Xiangyang and the Northern Expedition",
    xieProfilePoint4: "He returned to Hubei to develop Party and Youth League organizations in Xiangyang, later joined the Northern Expedition, worked in political publicity, and helped edit Hansheng Weekly.",
    xieProfilePeriod5: "1927–1928 · Northern Hubei and martyrdom",
    xieProfilePoint5: "He returned to northern Hubei for revolutionary work. Arrested while working underground in Hankou in 1928, he was executed that August at the age of 29.",
    xieSourcesTitle: "Sources",
    xieSourceSeuhistory: "Southeast University History Museum",
    xieSourceSeuaa: "Southeast University Alumni Association",
    xieSourceNanjing: "Nanjing Party History Office",
    ...
    chatAnswerLabel: "Avatar answer",
    chatEvidenceTitle: "Source evidence",
    chatEvidenceCount: "database records",
    chatEvidenceOpen: "Review sources",
    chatEvidenceClose: "Hide sources",
    chatEvidenceNote: "These database matches supplement the answer and help verify its historical basis.",
