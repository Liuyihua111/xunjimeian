...
const messages = {
  zh: {
    brandTitle: "东南大学",
    brandSubtitle: "SOUTHEAST UNIVERSITY",
    navHome: "首页",
    navOverview: "项目概览",
    navContext: "梅庵与团二大",
    navMeian: "梅庵",
    ...
    meianPageTitle: "梅庵：校园中的历史文化场域",
    meianPageLede: "从三江、两江时期的校园茅屋，到南京高等师范学校的讲习与集会空间，再到今天的校史教育场所，梅庵持续见证东南大学的校园记忆与青年传统。",
    congressEyebrow: "团二大",
    congressPageTitle: "团二大：青年理想的历史坐标",
    congressPageLede: "1923 年，中国社会主义青年团第二次全国代表大会在梅庵召开。会议将校园空间、青年选择与时代变革紧密联系，也成为共青团历史上的重要节点。",
    meianImageAlt: "梅庵建筑实景",
    tuanImageAlt: "历史照片中的梅庵建筑",
    meianPhotoNote: "梅庵实景，图片来源：东南大学校史文化网",
    tuanPhotoNote: "梅庵历史影像，图片来源：东南大学校史文化网",
    meianVideoEyebrow: "影像记录",
    meianVideoTitle: "新闻镜头中的梅庵",
    meianVideoSource: "视频来源：南京新闻",
  ...
  en: {
    ...
    meianPageTitle: "Mei'an: A Campus Site of History and Memory",
    meianPageLede: "From a modest campus hut in the Sanjiang and Liangjiang era to a lecture and meeting space at Nanjing Higher Normal School and a site for university-history education today, Mei'an continues to hold Southeast University's campus memory and youth tradition.",
    congressEyebrow: "Second CYL Congress",
    congressPageTitle: "The Second CYL Congress: A Historical Coordinate for Youth",
    congressPageLede: "In 1923, the Second National Congress of the Chinese Socialist Youth League convened at Mei'an, connecting a campus space, the choices of young people, and the transformation of an era.",
    ...
    meianVideoEyebrow: "Video Record",
    meianVideoTitle: "Mei'an through the News Camera",
    meianVideoSource: "Video source: Nanjing News",
    ...
    chatAnswerLabel: "Talk with Xie Yuanding",
    ...
    q1: "Who are you?",
    q2: "How are you connected to Southeast University?",
    q3: "Why did you attend the Second CYL Congress?",
