...
const zh = {
  ...
  overviewText: "1923年8月20日至25日，中国社会主义青年团第二次全国代表大会在南京国立东南大学梅庵召开。出席大会的代表有30余人，来自全国16个省、30多个地方团组织，代表全国2000多名团员。大会总结建团以来的工作，讨论青年运动方针和党团关系，为中国青年运动确立了更清晰的政治方向。",
  facts: [{ value: "30余名", label: "到会代表" }, { value: "16个省", label: "代表来源" }, { value: "30多个", label: "地方团组织" }, { value: "6日", label: "大会会期" }],
  ...
  preparation: [
    { date: "3月7日", text: "中共中央执行委员会研究青年团工作，提出在党的第三次全国代表大会之后召开团二大。" },
    { date: "5月10日", text: "团中央决定原拟于7月10日在长沙召开大会，并着手准备组织工作。" },
    { date: "6月以后", text: "受长沙“六一惨案”等形势影响，大会地点由长沙调整至南京国立东南大学。" },
    { date: "8月20日", text: "大会在国立东南大学梅庵正式开幕。" },
    { date: "8月25日", text: "大会完成各项议程并闭幕。" }
  ],
  ...
  relationsQuote: "在政策上，S.Y.须完全服从C.P.的指导，与C.P.的主张一致。",
  relationsText: "史料中的“S.Y.”指中国社会主义青年团，“C.P.”指中国共产党。团二大进一步明确党与团的政治关系和组织关系，使青年团成为党联系广大青年的桥梁，也为此后共青团事业发展奠定了思想与制度基础。",
  archivesKicker: "珍贵史料", archivesTitle: "从散落档案还原六日大会",
  archivesStat: "件团二大会议文件",
...
const en = {
  ...
  overviewText: "From 20 to 25 August 1923, the congress met at Mei'an on the campus of National Southeastern University in Nanjing. More than 30 delegates attended, coming from 16 provinces and over 30 local League organizations and representing more than 2,000 League members nationwide. The congress reviewed the League's early work and clarified the direction of China's youth movement.",
  facts: [{ value: "30+", label: "Delegates present" }, { value: "16", label: "Provinces represented" }, { value: "30+", label: "Local organizations" }, { value: "6 days", label: "Congress duration" }],
  ...
  preparation: [
    { date: "7 March", text: "The CPC Central Executive Committee discussed Youth League work and proposed holding the second congress after the Party's Third National Congress." },
    { date: "10 May", text: "The League Central Committee initially decided to convene the congress in Changsha on 10 July and began organizational preparations." },
    { date: "After June", text: "Following the June First Incident in Changsha and changing conditions, the venue moved to National Southeastern University in Nanjing." },
    { date: "20 August", text: "The congress formally opened at Mei'an." },
    { date: "25 August", text: "The congress completed its agenda and closed." }
  ],
  ...
  relationsQuote: "In policy, S.Y. must fully follow the guidance of C.P. and align its position with that of C.P.",
  relationsText: "In the historical document, “S.Y.” denotes the Socialist Youth League and “C.P.” the Communist Party of China. The congress clarified their political and organizational relationship, laying an important foundation for the later development of China's Communist Youth League.",
